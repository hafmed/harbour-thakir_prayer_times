...
public:
    ...
    Q_INVOKABLE int activeDownloads() const;
    Q_INVOKABLE int progressTotal() const;
    Q_INVOKABLE int progressValue() const;
    Q_INVOKABLE QString progressMessage();
