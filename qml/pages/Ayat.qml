...
Page {
            ...
            delegate: ListItem {
                ...
                Row {
                    ...
                    Text {
                        ...
                        (quranisShow? bismillah.length === 0? "(" + numArabicToHindi(index.toString()) + "): " + name :bismillah+ "\n(" + numArabicToHindi(index.toString()) + "): " + name//
                                                      : "(" + numArabicToHindi(index.toString()) + "): " + name) :
                            (quranisShow? bismillah.length === 0? "(" + index + "): " + name :bismillah+ "\n(" + index + "): " + name//
                                                          : "(" + index + "): " + name )//"\u202C"
    ...
    Rectangle {
        ...
        Row {
            ...
            Label {
                width: quranisShow ? parent.width /3 : parent.width
                height: Theme.itemSizeSmall
