...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            //        width: parent.width
            //        text: qsTr('Compass Sensor Calibration Level is <br>')+compass.calibrationLevel*100+"%"
            //        horizontalAlignment:TextEdit.AlignHCenter
            //    }
            //    Image {
            ...
            //        visible: compass.calibrationLevel!==1
            //        transform: Scale { origin.x: 0; origin.y: 0; xScale: .5; yScale: .5}
